        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2">
              ...
              <li><strong>Maine Coon:</strong> Large, gentle giants with long fur</li>
              <li><strong>Persian:</strong> Long-haired, flat-faced, and calm</li>
              <li><strong>Bengal:</strong> Spotted coat, active, and playful</li>
              <li><strong>Sphynx:</strong> Hairless, warm to the touch, and very affectionate</li>
            </ul>
          </CardContent>
        </Card>
      </div>
